...
public class BagCatFactory implements IComponentCollectionFactory {
	...
	public BagCatFactory(Texture catTex, Texture lazerTex, int health, Object movement) {
		this.catTex = catTex;
	...
	public List<Object> createComponents() {
		...
		components.add(new Laser(lazerTex, 3.0f, 2.0f, 1.0f, 0.5f, 5, -16.0f, 33.0f));
		components.add(new AnimationWrapper(lazerTex, 3, 1, 1.f / 6.f, Animation.PlayMode.LOOP_PINGPONG));
		return components;
	}
}
