...
public class Laser {
	...
	public Laser(Texture tex, float pauseSeconds, float pauseVariance, float onTimeSeconds, float onTimeVariance, int damage, float xRenderOffset, float yRenderOffset) {
		this.tex = tex;
